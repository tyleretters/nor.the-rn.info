...
![Congratulations!]({{ site.image_path | append: "congratulations.jpg" }})
*Congratulations!*
...
![U.S. Strikes Iraq]({{ site.image_path | append: "us-strikes-iraq.jpg" }})
...
![Timewave Zero]({{ site.image_path | append: "timewave-zero.jpg" }})
...
![Me performing, circa 2008.]({{ site.image_path | append: "healthy-outlets.jpg" }})
...
![GFAJ-1]({{ site.image_path | append: "gfaj-1.jpg" }})
*It's happening!*
