...
Most of the work was done in the month of March. Principal contributors were myself, [Jordan / @eigen](https://norns.community/en/authors/eigen), and [Dan / @dan_derks](https://norns.community/en/authors/dan_derks). (_Meta: dang, that feels good to link to to it!_) As usual, this project saw plenty of collaboration from dozens of members of the monome community.
...
The Discourse platform was designed for nurturing communities and having engaging discussions. Using a forum post as the home-base for scripts was a natural evolution. Scripts, however, are essentially "products" that you have to "shop" for. (Even though all the scripts are open source and free, there you still have to find the script, figure out if it is something you're interested in, make the decision to install it, learn how to use it, etc.) This requires a whole new set of features that go beyond what Discourse was designed to do:

- As a norns owner I need a way to explore new scripts.
- As a norns owner I need support using the software.
- As a script author I need a place to document large amounts of technical data.
- As a script author I need to spread awareness (market) my script.

All of these things (and more) started happening in Discourse. One of my early solutions for the documenation issue was to break my documentation out into a dedicated [GitHub Pages](https://northern-information.github.io/arcologies-docs/) site. Another solution, like Dan did with Cheat Codes, was to make a downloadable PDF. Both tasks require a relatively high degree of patience, passion, and technical proficiency.
...
wiki.js doesn't support custom themes but it does allow you to inject CSS and JS, however. I tried to keep this as minimal as possible. There's maybe CSS 10 delcarations total. Most of them just changing colors or hiding elements.

I was sure to add some fun stuff in, too. The login page features a technical schematic of the norns.
...
There are two main persona's of the site. For script authors, we wanted a detailed set of instructions, so we setup a page with lots of screenshots and code templates.

For non-authors, the key was *subtraction*. We made sure to keep the navigation as flat as possible and disable comments (Discourse is already great for that.)

Dan setup authentication to work with both GitHub and Discord so people didn't have to make yet another account. Authors login with GitHub accounts which they must already have to get their work published in maiden, the script catalog. Editors need a Discord account and to be in the [norns study group](https://norns.community/study-group). The thinking here is this would afford us some degree of resilience against vandalism.
...
I hope you enjoy using [norns.community](https://norns.community) as much as I enjoyed making it.
